  ...
  m_config(config)
{
   ...
   top::check( m_tauSelectionEleOLR.setProperty("ConfigPath", std::string(rc)+"/data/HowtoExtendAnalysisTop/EleOLR_tau_selection.conf" ), "TauSelectionEleOLR:Failed to set ConfigPath");
  top::check( m_tauSelectionEleOLR.initialize(), "Failed to initialise TauSelectionTool for EleOLR" );

  top::check( m_tauSelectionEleBDT.setProperty("ConfigPath", std::string(rc)+"/data/HowtoExtendAnalysisTop/EleOLR_tau_selection.conf" ), "TauSelectionEleBDT:Failed to set ConfigPath");
  top::check( m_tauSelectionEleBDT.initialize(), "Failed to initialise TauSelectionTool for EleBDT" );

  top::check( m_tauSelectionMuonOLR.setProperty("ConfigPath", std::string(rc)+"/data/HowtoExtendAnalysisTop/EleOLR_tau_selection.conf" ), "TauSelectionMuonOLR:Failed to set ConfigPath");

...
std::vector< asg::AnaToolHandle<ITrigGlobalEfficiencyCorrectionTool>> m_trigGlobTools; /// as class member
 ...
 // ttHMultilepton::ClassifyHF* m_classifyttbarHF;
  ...
  // names tau SFs
    ...
    /*  { top::topSFSyst::TAU_SF_ELEOLR_TOTAL_UP,   "TAU_SF_ELEOLR_TOTAL_UP"  },
      ...
      { top::topSFSyst::TAU_SF_TRUEELECTRON_ELEOLR_SYST_DOWN,   "TAU_SF_TRUEELECTRON_ELEOLR_SYST_DOWN"  },
      { top::topSFSyst::TAU_SF_TRUEELECTRON_ELEOLR_SYST_UP, "TAU_SF_TRUEELECTRON_ELEOLR_SYST_UP"},
      { top::topSFSyst::TAU_SF_TRUEELECTRON_ELEBDT_MC16A_DOWN,   "TAU_SF_TRUEELECTRON_ELEBDT_MC16A_DOWN"  },
      { top::topSFSyst::TAU_SF_TRUEELECTRON_ELEBDT_MC16A_UP, "TAU_SF_TRUEELECTRON_ELEBDT_MC16A_UP"},
      { top::topSFSyst::TAU_SF_TRUEELECTRON_ELEBDT_MC16D_DOWN,   "TAU_SF_TRUEELECTRON_ELEBDT_MC16D_DOWN"  },
      { top::topSFSyst::TAU_SF_TRUEELECTRON_ELEBDT_MC16D_UP, "TAU_SF_TRUEELECTRON_ELEBDT_MC16D_UP"},
      { top::topSFSyst::TAU_SF_TRUEELECTRON_ELEBDT_SYST_DOWN,    "TAU_SF_TRUEELECTRON_ELEBDT_SYST_DOWN"   },
      { top::topSFSyst::TAU_SF_TRUEELECTRON_ELEBDT_SYST_UP,  "TAU_SF_TRUEELECTRON_ELEBDT_SYST_UP" },
      { top::topSFSyst::TAU_SF_TRUEELECTRON_ELEOLR_SYST_DOWN,   "TAU_SF_TRUEELECTRON_ELEOLR_SYST_DOWN"  },
      { top::topSFSyst::TAU_SF_TRUEELECTRON_ELEOLR_SYST_UP, "TAU_SF_TRUEELECTRON_ELEOLR_SYST_UP"},
      { top::topSFSyst::TAU_SF_JETID_1P2025_DOWN,   "TAU_SF_JETID_1P2025_DOWN"  },
      { top::topSFSyst::TAU_SF_JETID_1P2025_UP, "TAU_SF_JETID_1P2025_UP"},
      ...
      { top::topSFSyst::TAU_SF_JETID_SYST_DOWN,   "TAU_SF_JETID_SYST_DOWN"  },
      { top::topSFSyst::TAU_SF_JETID_SYST_UP, "TAU_SF_JETID_SYST_UP"},
      { top::topSFSyst::TAU_SF_JETID_AF2_DOWN,   "TAU_SF_JETID_AF2_DOWN"  },
      { top::topSFSyst::TAU_SF_JETID_AF2_UP, "TAU_SF_JETID_AF2_UP"},

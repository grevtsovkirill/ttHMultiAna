...
//      newTau->makePrivateStore(*tauItr);
  ...
  std::string m_OR_electrons1;
  m_OR_electrons1 = m_OR_electrons;
  if(m_config->systematicName(event.m_hashValue)!="nominal"){
    m_OR_electrons1 = m_OR_electrons + "_"+ m_config->systematicName(event.m_hashValue) ;
  }
  ...
  std::string m_OR_muons1;
  m_OR_muons1 = m_OR_muons;
  if(m_config->systematicName(event.m_hashValue)!="nominal"){
    m_OR_muons1 = m_OR_muons + "_"+ m_config->systematicName(event.m_hashValue) ;
  }
  ...
  std::string m_OR_jets1;
  m_OR_jets1 = m_OR_jets;
  if(m_config->systematicName(event.m_hashValue)!="nominal"){
    m_OR_jets1 = m_OR_jets + "_"+ m_config->systematicName(event.m_hashValue) ;
  }
  ...
  std::string m_OR_taus1;
  m_OR_taus1 = m_OR_taus;
  if(m_config->systematicName(event.m_hashValue)!="nominal"){
    m_OR_taus1 = m_OR_taus + "_"+ m_config->systematicName(event.m_hashValue) ;
  }

...
void ttHML::Tau::BootstrapTree(std::shared_ptr<top::TreeManager> tree, int index) {
  ...
  CreateBranch(tree, &promptTauInput_TrackJetNTrack, "lep_promptTauInput_TrackJetNTrack_", index);
  CreateBranch(tree, &promptTauInput_JetF, "lep_promptTauInput_JetF_", index);
  CreateBranch(tree, &promptTauInput_DRlj, "lep_promptTauInput_DRlj_", index);
  CreateBranch(tree, &promptTauInput_LepJetPtFrac, "lep_promptTauInput_LepJetPtFrac_", index);
  CreateBranch(tree, &promptTauInput_SV1, "lep_promptTauInput_SV1_", index);
  CreateBranch(tree, &promptTauInput_MV2c10rnn, "lep_promptTauInput_MV2c10rnn_", index);
  CreateBranch(tree, &promptTauInput_ip2, "lep_promptTauInput_ip2_", index);
  CreateBranch(tree, &promptTauInput_ip3, "lep_promptTauInput_ip3_", index);
  CreateBranch(tree, &promptTauInput_rnnip, "lep_promptTauInput_rnnip_", index);
